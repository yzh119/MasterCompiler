 ...
 */
public class LShiftIns extends Arithmetic {
    ValRegister r1, r2, r3;
    public LShiftIns(ValRegister r1, ValRegister r2, ValRegister r3) {
        this.r1 = r1;
        this.r2 = r2;
        this.r3 = r3;
    }
    ...
    public String toString() {
        return "lshift " + r1.toString() + " " + r2.toString() + " " + r3.toString();
    }
}
