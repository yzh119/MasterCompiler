 ...
 */
public class LShiftIIns extends Arithmetic{
    ValRegister r1, r3;
    Immediate c2;
    public LShiftIIns(ValRegister r1, Immediate c2, ValRegister r3) {
        this.r1 = r1;
        this.c2 = c2;
        this.r3 = r3;
    }
    ...
    public String toString() {
        return "lshiftI " + r1.toString() + " " + c2.toString() + " " + r3.toString();
    }
