...
import com.expye.compiler2016.IR.YIR.Arithmetic.BinaryIns.RShiftIns;
...
public class RshiftExp extends BinExp {
    ...
    public void emit(List<Instruction> lst) {
        ...
        if (lhs instanceof IntExp) {
            ...
            lst.add(
                    new RShiftIns((IRRegister) this.reg, newReg, rhs.reg)
            );
        } else
        lst.add(
                new RShiftIns((IRRegister) this.reg, (IRRegister) lhs.reg, rhs.reg)
        );
    }
}
