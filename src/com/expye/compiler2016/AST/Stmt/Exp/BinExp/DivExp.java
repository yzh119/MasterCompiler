...
import com.expye.compiler2016.IR.ILOC.Arithmetic.ArithmeticImmediate.DivIIns;
import com.expye.compiler2016.IR.ILOC.Arithmetic.ArithmeticImmediate.SubIIns;
import com.expye.compiler2016.IR.ILOC.Arithmetic.DivIns;
    ...
    public void toILOC() {
        ...
        if (rhs instanceof IntExp) {
            ILOC.ILOCinstance.addIns(
                    new DivIIns((ValRegister) lhs.reg, (Immediate) rhs.reg, (ValRegister) this.reg)
            );
        } else {
            ...
            ILOC.ILOCinstance.addIns(
                    new DivIns((ValRegister) lhs.reg, (ValRegister) rhs.reg, (ValRegister) this.reg)
            );
        }
    }
}
