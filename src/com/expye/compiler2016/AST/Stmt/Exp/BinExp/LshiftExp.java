...
import com.expye.compiler2016.IR.YIR.Arithmetic.BinaryIns.LShiftIns;
...
public class LshiftExp extends BinExp {
    ...
    public void emit(List<Instruction> lst) {
        ...
        if (lhs instanceof IntExp) {
            ...
            lst.add(
                    new LShiftIns((IRRegister) this.reg, newReg, rhs.reg)
            );
        } else
        lst.add(
                new LShiftIns((IRRegister) this.reg, (IRRegister) lhs.reg, rhs.reg)
        );
    }
}
